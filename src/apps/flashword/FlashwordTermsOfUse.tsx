        ...
        <Container>
            ...
            <Row>
                <Col>
                    ...
                    <p><Trans i18nKey="flashword.terms-of-use.description.1">Flashword is governed by <Link
                        className="blue-link" to="https://www.apple.com/legal/internet-services/itunes/dev/stdeula/">
