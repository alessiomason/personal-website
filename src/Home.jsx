...
import { ArrowDown, Laptop, Phone, FiletypeJsx, Server, FiletypePhp, Apple, Android, HourglassSplit, Github, Mastodon } from 'react-bootstrap-icons';
...
function SecondHomeSlide() {
  ...
  return (
    <div className='d-flex flex-column justify-content-between full-screen-slide second-home-slide primary-yellow'>
      ...
      <Row>
        <Col sm={{ span: 4, offset: 1 }} className='border-line-around-animation'>
        ...
        <Col sm={{ span: 4, offset: 2 }} className='border-line-around-animation'>
          <h3 className='text-center'>Lavori e progetti</h3>
          <span className='d-flex justify-content-center'><HourglassSplit className='waiting-icon' /></span>
